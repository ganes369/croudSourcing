      ...
      <div className="flex h-screen-navbar">
        ...
        <div className="flex flex-1 justify-center pl-10 pr-10 pb-10 overflow-auto ">
          <div className="mt-20 max-w-[588px] w-[100%]">
            <TextInput
              onChange={(event) =>
                handleChangeState({ title: event.target.value })
              }
              value={state.title}
            ...
            <TextArea
              onChange={(event) =>
                handleChangeState({ description: event.target.value })
              }
            ...
            <div className="flex flex-col">
              ...
              <div className="flex gap-2 max-w-[100%]">
                <TextInput
                  onChange={(event) =>
                    handleChangeState({ uf: event.target.value })
                  }
                  value={state.uf}
                  label=""
                ...
                <TextInput
                  onChange={(event) =>
                    handleChangeState({ city: event.target.value })
                  }
                  value={state.city}
                  label=""
                  placeholder="Cidade"
                ...
                <TextInput
                  onChange={(event) =>
                    handleChangeState({ neighborhood: event.target.value })
                  }
            ...
            <TextInput
              ...
              onChange={(event) =>
                handleChangeState({ imageUrl: event.target.value })
              }
            ...
            <TextInput
              onChange={(event) =>
                handleChangeState({ pix: event.target.value })
              }
              value={state.pix}
              label="Chave Pix"
              labelClassNames={`${labelStyle} mb-0`}
            ...
            <Select
              onChange={(event) =>
                handleChangeState({ votingPeriod: event.target.value })
              }
